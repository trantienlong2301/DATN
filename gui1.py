...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Up.setGeometry(QtCore.QRect(60, 500, 91, 91))
        self.Up.setObjectName("Up")
        self.Down = QtWidgets.QPushButton(self.centralwidget)
        self.Down.setGeometry(QtCore.QRect(60, 610, 91, 91))
        self.Down.setObjectName("Down")
        self.Right = QtWidgets.QPushButton(self.centralwidget)
        self.Right.setGeometry(QtCore.QRect(180, 610, 91, 91))
        self.Right.setObjectName("Right")
        self.Left = QtWidgets.QPushButton(self.centralwidget)
        self.Left.setGeometry(QtCore.QRect(180, 500, 91, 91))
        self.Left.setObjectName("Left")
        self.Clock = QtWidgets.QPushButton(self.centralwidget)
        self.Clock.setGeometry(QtCore.QRect(60, 720, 91, 91))
        self.Clock.setObjectName("Clock")
        self.ReClock = QtWidgets.QPushButton(self.centralwidget)
        self.ReClock.setGeometry(QtCore.QRect(180, 720, 91, 91))
        ...
        self.Update.setGeometry(QtCore.QRect(110, 380, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Update.setText(_translate("MainWindow", "Updata"))
